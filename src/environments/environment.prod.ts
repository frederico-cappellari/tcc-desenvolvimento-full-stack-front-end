export const environment = {
  ...
  clientUrl: 'https://apm03.hml.intra.rs.gov.br',
  ...
  soeauth: {
    ...
    redirectUrl: "https://apm03.hml.intra.rs.gov.br",
    postLogoutRedirectUri: "https://apm03.hml.intra.rs.gov.br",
    scope: 'openid',
    responseType: 'code',
    silentRenew: true,
  ...
  loginCidadao: {
    ...
    responseType: 'code',
    redirectUrl: "https://apm03.hml.intra.rs.gov.br",
    postLogoutRedirectUri: "https://apm03.hml.intra.rs.gov.br/login",
  },
